...
namespace HospitalDef.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEspecialidad,Especialidades")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEspecialidad,Especialidades")] Especialidade especialidade)
        {
