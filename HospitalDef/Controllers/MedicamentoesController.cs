...
namespace HospitalDef.Controllers
{
    public class MedicamentoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMedicamento,NombreMedicamento,Lote,Caducidad,PrecioCompra,PrecioVenta,Ubicacion,Stock")] Medicamento medicamento)
        {
